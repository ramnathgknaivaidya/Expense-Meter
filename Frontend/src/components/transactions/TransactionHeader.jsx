import { Search, Plus, Filter } from '../icons'
import { debounce } from '../../lib/transactions'

export default function TransactionHeader({
  searchQuery, onSearchChange, onAddTransaction, onToggleFilters, showFilters
}) {
    ...
    <div style={{ marginBottom: 24 }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 16, flexWrap: 'wrap' }}>
        <div>
          ...
          <p style={{ color: 'var(--text-secondary)', marginTop: 4, margin: 0 }}>Manage and track your financial transactions</p>
        </div>
